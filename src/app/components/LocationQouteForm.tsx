...
export default function LocationQuoteForm() {
  ...
  return (
    <form
      ...
      className="w-2/5 px-4 py-6 xl:px-8 xl:py-14 bg-white z-10 rounded-2xl flex flex-col gap-4 xl:gap-6"
    >
      <div className="flex flex-col gap-1 xl:gap-3">
        <label className="text-lg xl:text-2xl uppercase">
          Pick Up Location
        </label>
        <div className="relative">
          ...
          <input
            ...
            className={`w-full px-8 py-2 xl:py-4 border rounded-lg focus:outline-none focus:ring-2 ${
              errors.pickup
      ...
      <button
        type="submit"
        className="bg-[#0B6AF0] text-white text-xl px-8 py-3 rounded-full w-full cursor-pointer"
      >
        Get Quote
      </button>
    </form>
